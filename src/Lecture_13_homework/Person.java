...
public class Person {
    ...
    public void traditionalDish (){
        ...
        switch (this.nationality.toLowerCase()){
            case "italian":

                System.out.println("Traditional dish of the italians is: Pasta");
                        break;
            case "bulgarian":
                System.out.println("Traditional dish of the bulgarians is: Musaka");
                break;
            default:
                System.out.println("We don't know the " + nationality + " traditional Dish.");
    ...
    public void whenItsNamesDay(){
       if (getName().equals("George")){
           System.out.println(getName() + " have name day on 6th of May.");
       }
       else{
           System.out.println("We don't know when " + getNationality() +" have name days.");
       }
